document.addEventListener("DOMContentLoaded", () => {
  // 1. Definição do conteúdo REAL de cada categoria
  ...
  // 2. Seleção dos elementos do HTML (código inalterado)
  ...
  // 3. Função para mostrar as diretrizes (código inalterado)
  ...
  // 4. Função para voltar para a grade (código inalterado, com um pequeno ajuste)
  function showGrid() {
    guidelinesContent.style.display = "none";
    projectIntro.style.display = "block"; // Mostra a introdução novamente
    categoryGrid.style.display = "grid";
  }

  // 5. Adiciona os "escutadores" de eventos (código inalterado)
